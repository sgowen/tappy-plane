...
extern "C"
{
JNIEXPORT void JNICALL Java_com_gowengamedev_tappyplane_RendererWrapper_on_1surface_1created(JNIEnv * env, jclass cls, jint pixel_width, jint pixel_height);
JNIEXPORT void JNICALL Java_com_gowengamedev_tappyplane_RendererWrapper_on_1surface_1changed(JNIEnv * env, jclass cls, jint pixel_width, jint pixel_height, jint dp_width, jint dp_height);
JNIEXPORT void JNICALL Java_com_gowengamedev_tappyplane_RendererWrapper_init(JNIEnv* env, jclass cls);
...
JNIEXPORT short JNICALL Java_com_gowengamedev_tappyplane_RendererWrapper_get_1current_1sound_1id(JNIEnv* env, jclass cls);
JNIEXPORT int JNICALL Java_com_gowengamedev_tappyplane_RendererWrapper_get_1state(JNIEnv* env, jclass cls);
JNIEXPORT void JNICALL Java_com_gowengamedev_tappyplane_RendererWrapper_clear_1state(JNIEnv* env, jclass cls);
JNIEXPORT int JNICALL Java_com_gowengamedev_tappyplane_RendererWrapper_get_1score(JNIEnv* env, jclass cls);
JNIEXPORT void JNICALL Java_com_gowengamedev_tappyplane_RendererWrapper_set_1best_1score(JNIEnv* env, jclass cls, jint best_score);
JNIEXPORT bool JNICALL Java_com_gowengamedev_tappyplane_RendererWrapper_handle_1on_1back_1pressed(JNIEnv* env, jclass cls);
};
