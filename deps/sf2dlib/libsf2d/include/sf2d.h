 ...
 */
int sf2d_init(float topScreenWidth, float topScreenHeight, float bottomScreenWidth, float bottomScreenHeight);
 ...
 * @return Whether the initialization has been successful or not
 */
int sf2d_init_advanced(float topScreenWidth, float topScreenHeight, float bottomScreenWidth, float bottomScreenHeight, int gpucmd_size, int temppool_size);
...
void sf2d_draw_batch_circle(sf2d_vertex_pos_col* vertices, int numPoints);
 ...
 */
void sf2d_draw_quad_uv(const sf2d_texture *texture, float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4, float u1, float v1, float u2, float v2, float u3, float v3, float u4, float v4, u32 color, unsigned int params);
