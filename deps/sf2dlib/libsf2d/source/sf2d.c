...
int sf2d_init_advanced(float topScreenWidth, float topScreenHeight, float bottomScreenWidth, float bottomScreenHeight, int gpucmd_size, int temppool_size)
{
	...
	matrix_init_orthographic(ortho_matrix_top, 0.0f, topScreenWidth, 0.0f, topScreenHeight, 0.0f, 1.0f);
	matrix_init_orthographic(ortho_matrix_bot, 0.0f, bottomScreenWidth, 0.0f, bottomScreenHeight, 0.0f, 1.0f);
